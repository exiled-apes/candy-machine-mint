...
- Follow the instructions [here](https://docs.metaplex.com/candy-machine-v2/getting-started) to install the Metaplex Command Line Utility.
...
3. Define your environment variables using the instructions below, and start up the server with `yarn start`.
...
This is a Solana account address. This value will be printed in your terminal after running the metaplex `upload` command. See [here](https://docs.metaplex.com/candy-machine-v2/creating-candy-machine) for more information.
